...
job_id_map = {
	...
	'#2345':{'location':{'addr':'823 11th Ave, New York, NY 10019, USA', 'lat':'40.756903', 'lon':'-73.984376'},'issue':{'type':'installation'}, 'equipments':['Machine 2', 'Analyzer A', 'Monitor Plus 1.0', 'Apparatus v2'], 'services':['Small Business Basics'], 'engineer':{'id':'110257721827374623737', 'name':'Joe'}, 'customer':{'id':'108560908635605545932', 'name':'Robert'}, 'notes':['Installation of several items'], 'documents':['Doc2 :: URL2']},
	'#3456':{'location':{'addr':'445 W 59th St, New York, NY 10019, USA', 'lat':'40.756903', 'lon':'-73.984376'},'issue':{'type':'repair/maintenance'}, 'equipments':['Machine 1', 'Toolkit A3'], 'services':['Home Essentials Package'], 'engineer':{'id':'110257721827374623737', 'name':'Joe'}, 'customer':{'id':'102345940077083980832', 'name':'Ryan'}, 'notes':['Repair and maintenance of several items'], 'documents':['Doc3 :: URL3']},
	'#4567':{'location':{'addr':'665 5th Ave, New York, NY 10022, USA', 'lat':'40.756903', 'lon':'-73.984376'},'issue':{'type':'repair/maintenance'}, 'equipments':['Appliance 1', 'Toolkit X', "10' Cables"], 'services':['Enterprise Economy Bundle'], 'engineer':{'id':'110257721827374623737', 'name':'Joe'}, 'customer':{'id':'107612119418245526899', 'name':'Rachel'}, 'notes':['Repair and maintenance of several items'], 'documents':['Doc4 :: URL4']},
	'#5678':{'location':{'addr':'524 Park Ave, New York, NY 10065, USA', 'lat':'40.756903', 'lon':'-73.984376'},'issue':{'type':'estimate/inspection'}, 'equipments':['Appliance Model 2', 'Tracker Module', 'Receipt Pad'], 'services':['Diamond Enterprise Bundle'], 'engineer':{'id':'110257721827374623737', 'name':'Joe'}, 'customer':{'id':'108612246962932756480', 'name':'Rose'}, 'notes':['Estimation and inspection of several items'], 'documents':['Doc5 :: URL5']}
}
